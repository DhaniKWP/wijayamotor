...
<div class="fixed bottom-6 right-6 z-50 flex items-center gap-3">
  ...
  <a href="https://wa.me/62895321813103" target="_blank" rel="noopener noreferrer" 
     class="flex items-center justify-center w-[60px] h-[60px] bg-[#25D366] text-white rounded-full shadow-xl hover:shadow-2xl hover:-translate-y-1 hover:scale-105 transition-all duration-300 relative group">
